...
(setq user-full-name "Halston Sellentin"
      user-mail-address "halston@sellent.in")
...
;(setq +doom-dashboard-ascii-banner-fn #'think_different)
(setq fancy-splash-image (concat doom-private-dir "apple.svg"))
